...
export default function TrainerLogin() {
  ...
  return (
    ...
    <div className=' min-h-screen bg-[#183D3D] flex justify-center items-center py-10'>
      <div className=' h-96 lg:w-96 w-80 bg-[#040D12] rounded-2xl p-5 flex flex-col justify-between items-center gap-5 py-5'>
        ...
        onChange={(e)=>{Setpassword(e.target.value)}} />
         <button className={` px-10 py-3 bg-[#183D3D] text-[#d4af37] font-[Poppins] rounded-xl hover:bg-[#112e2e] ${loading ? 'cursor-not-allowed':'cursor-pointer'}`} onClick={handlesubmit}>Sign in</button>

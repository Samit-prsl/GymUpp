...
export default function Register() {
  ...
  return (
    <div className=' min-h-screen bg-[#040D12] flex justify-center items-center py-10'>
      <div className=' h-[600px] lg:w-96 w-80 bg-[#165050] rounded-2xl p-5 flex flex-col justify-between items-center gap-5 py-5'>
        ...
        onChange={(e)=>{
         ...
         <button className=' px-10 py-3 bg-[#040D12] text-[#d4af37] font-[Poppins] rounded-xl hover:bg-[#0d1b22]' onClick={handlesubmit}>Register</button>
